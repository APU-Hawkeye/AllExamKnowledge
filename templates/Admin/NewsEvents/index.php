...
<div class="topbar-nav">
    <nav class="navbar navbar-expand fixed-top bg-white">
        <ul class="navbar-nav mr-auto align-items-center">
            ...
            <h5 class="text-dark mb-0"><?php echo __('News Events'); ?></h5>
        </ul>
                ...
                <?php if ($newEvents->isEmpty() === false) { ?>
                    ...
                    foreach ($newEvents as $event) {?>
                        <tr>
                            ...
                            <td><?php echo $event->description ? getWords($event->description) : 'Not Available';?></td>
                            <td><?php echo $event->link ?: __('Not Available') ;?></td>
                            <td><?php echo $event->disabled ?? __('Active') ;?></td>
                        </tr>
                    <?php } ?>
                <?php } else { ?>
                    <tr>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fa fa-server"></i><?php echo __(' Add News Events')?></h5>
