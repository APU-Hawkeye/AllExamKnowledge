 ...
 * @var \Cake\Datasource\ResultSetInterface $students
 */
?>
<style>
    .toolbar .btn{
...
<div class="topbar-nav">
    <nav class="navbar navbar-expand fixed-top bg-white">
        <ul class="navbar-nav mr-auto align-items-center">
            ...
            <h5 class="text-dark mb-0"><?php echo __('Students'); ?></h5>
        </ul>
    ...
    <div class="container-fluid pl-0 pr-0">
        ...
        <div class="table-responsive bg-white">
            <table class="table table-bordered mb-0">
                ...
                <tbody>
                <?php if ($students->isEmpty() === false) { ?>
                    <?php /** @var \App\Model\Entity\Student $student */
                    foreach ($students as $student) {?>
                        <tr>
                            ...
                            <td><?php echo $student->gender ?? 'Not Available' ;?></td>
                            <td><?php echo $student->date_of_birth ?? 'Not Available' ;?></td>
                            <td><?php echo $student->created ;?></td>
                            <td><?php echo $student->disabled ?? __('Active') ;?></td>
                        </tr>
                    <?php } ?>
                <?php } else { ?>
                    <tr>
