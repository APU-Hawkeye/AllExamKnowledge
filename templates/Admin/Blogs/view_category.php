 ...
 * @var \App\Model\Entity\BlogCategory $category
 */
?>
<div class="topbar-nav">
    <nav class="navbar navbar-expand fixed-top bg-white">
        <ul class="navbar-nav mr-auto align-items-center">
            ...
            <h5 class="text-dark mb-0"><?php echo __('Blog Category - '.$category->title) ?></h5>
        </ul>
        ...
        <?php } ?>
        <button class="btn btn-sm btn-outline-primary m-1" data-toggle="modal" data-target="#editCategory"><?php echo __("Edit")?></button>
    </nav>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fa fa-server"></i><?php echo __(' Edit Blog Category')?></h5>
...
if ($category->disabled) {
    ...
    echo $this->element('confirm_dialog', [
        ...
        'title' => __("Warning"),
        'content' => __("Are you sure, you want to enable {0}", '<strong>'.$category->first_name.'</strong>')
    ]);
}
?>
...
$(function(){
    ...
    $('#editCategory').find('form').eq(0).submit(function(event){
